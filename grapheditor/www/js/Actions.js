...
Actions.prototype.init = function()
{
	...
	//:ADDED:PELLEGRINI:24/03/2018:temporary, dont make a difference with "save" for the moment
	this.addAction('generatePython', function() { ui.generatePython(false); }, null, null, Editor.ctrlKey + '+G').isEnabled = isGraphEnabled;
	//:MODIFIED:PELLEGRINI:28/03/2018:changed "export..." to exportSVG
	this.addAction('exportSVG', function() { ui.showDialog(new ExportDialog(ui).container, 300, 230, true, true); });
	...
	//MODIFIED:PELLEGRINI:24/03/2018:Changed shortcut from ctrl+g to ctrl+shift+g
	...
	action = this.addAction('grid', function()
	{
		...
		//MODIFIED:PELLEGRINI:24/03/2018:Removed shortcut
	});
